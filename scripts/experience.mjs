export default {
  designation: ['Senior Software Engineer', 'Associate Engineer', 'Software Developer (Freelance)', 'Software Developer (Freelance)', 'Associate Systems Engineer', 'Data Science Intern'],
  ...
  tasks: [[
    'Remotely working with USA client',
    'Leading a team of 4 developers',
    'Building frontend with React and Typescript',
    'Using best practices for better maintainability and readability of codebase',
    'Unit testing, performance optimizing, PR reviewing, etc.'],
  ['Star Performer of the month (Sept 2021',
    'Built frontend with React and Typescript',
    'Used Redux for state management',
    'Built backend with Node, MongoDB and GraphQL',
    'Wrote blogs on Javascript concepts',
    'Gave talks on Javascript concepts',
    'Used best practices for better maintainability and readability of codebase'],
  [
  ...
  ['Worked on TCS’ online fresher training application',
  ...
  images: ['images/trantor.jfif', 'images/successive.png', 'images/scibi.jfif', 'images/aquintis.jfif', 'images/tcs.png', 'images/ixxo-min.png'],
